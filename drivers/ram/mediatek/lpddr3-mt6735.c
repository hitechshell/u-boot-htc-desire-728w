...
static int mtk_lpddr3_probe(struct udevice *dev)
{
    ...
    ofnode_read_u32(dev_ofnode(dev), "drvctrl0", &priv->drvctl0);
    ofnode_read_u32(dev_ofnode(dev), "drvctrl1", &priv->drvctl1);
    ...
    ofnode_read_u32(dev_ofnode(dev), "test2_2", &priv->test2_2);
    ...
    ofnode_read_u32(dev_ofnode(dev), "padctl4", &priv->padctl4);
    ...
    ofnode_read_u32(dev_ofnode(dev), "modereg3", &priv->modereg3);
    ofnode_read_u32(dev_ofnode(dev), "modereg5", &priv->modereg5);
    ofnode_read_u32(dev_ofnode(dev), "modereg10", &priv->modereg10);
    ofnode_read_u32(dev_ofnode(dev), "modereg63", &priv->modereg63);
    ofnode_read_u32(dev_ofnode(dev), "dqsctl1", &priv->dqsctl1);
    ofnode_read_u32(dev_ofnode(dev), "dqsgctl", &priv->dqsgctl);
    ofnode_read_u32(dev_ofnode(dev), "dqidly1", &priv->dqidly1);
    ofnode_read_u32(dev_ofnode(dev), "dqidly2", &priv->dqidly2);
    ofnode_read_u32(dev_ofnode(dev), "dqidly3", &priv->dqidly3);
    ofnode_read_u32(dev_ofnode(dev), "dqidly4", &priv->dqidly4);
    ofnode_read_u32(dev_ofnode(dev), "dqidly5", &priv->dqidly5);
    ofnode_read_u32(dev_ofnode(dev), "dqidly6", &priv->dqidly6);
    ofnode_read_u32(dev_ofnode(dev), "dqidly7", &priv->dqidly7);
    ofnode_read_u32(dev_ofnode(dev), "dqidly8", &priv->dqidly8);
    ...
    ofnode_read_u32(dev_ofnode(dev), "r0deldly", &priv->r0deldly);
    ofnode_read_u32(dev_ofnode(dev), "r1deldly", &priv->r1deldly);
    ofnode_read_u32(dev_ofnode(dev), "r0dqsien", &priv->r0dqsien);
    ofnode_read_u32(dev_ofnode(dev), "r1dqsien", &priv->r1dqsien);
    ofnode_read_u32(dev_ofnode(dev), "spcmd", &priv->spcmd);
